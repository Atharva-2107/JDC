...
export default function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result) {
                ...
                const selectedRole = result.role || role;
                if (selectedRole === 'hospital' || selectedRole === 'admin') {
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#060b14', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, position: 'relative', overflow: 'hidden' }}>
            {/* BG orbs */}
            <div style={{ position: 'absolute', top: '-20%', left: '-10%', width: 500, height: 500, background: 'radial-gradient(circle, rgba(16,185,129,0.06) 0%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none' }} />
            ...
            <div style={{ width: '100%', maxWidth: 480, animation: 'fadeInUp 0.5s ease' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 32 }}>
                    <div style={{ width: 64, height: 64, background: 'linear-gradient(135deg, #10b981, #3b82f6)', borderRadius: 18, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 30, margin: '0 auto 16px', boxShadow: '0 0 30px rgba(16,185,129,0.4)' }}>🛡️</div>
                    <h1 style={{ fontSize: 28, fontWeight: 800, color: '#f1f5f9', marginBottom: 6 }}>CrashGuard</h1>
                    <p style={{ fontSize: 14, color: '#64748b' }}>Create your emergency response account</p>
                </div>
